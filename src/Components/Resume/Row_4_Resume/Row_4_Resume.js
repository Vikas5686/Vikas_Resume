    ...
    <div>
      <div className="row Row_4 " id='Resume'>
        <div className="col-md-9 reveal" data-aos="fade-up" data-aos-offset="200"
          ...
          <p>Born To Solve Problem That Did Not Solve Before</p>
